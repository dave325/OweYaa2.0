...
class CompanyController extends Controller
{
    ...
    public function returnUser(Request $rq){
        $temp = User::with('contactInfo', 'skill', 'language', 'wantedSkills', 'availability', 'monthAvailability', 'certifications', 'mentor', 'course', 'social', 'education', 'careerSearch', 'goals', 'events', 'bootcamp', 'actionTask', 'prevCareerFields', 'careerGoals', 'hobbies', 'interviews','files')->where('username', '=', $rq->input('username'))->first();
