...
class User extends Model implements AuthenticatableContract, AuthorizableContract, JWTSubject
{
    ...
    {
        return $this->hasOne('App\TableModels\CompanyModels\CompanyProject\MembershipToken', 'username');
    }
        ...
        foreach ($projId as $id) {
            ...
            if(isset($cList))
            {
                ...
                foreach($cList as $candidate)
                {
                    ...
                    $contactAddenium = array('username' => $username,'email'=>$email,'firstName'=>$firstName,'lastName'=>$lastName, 'hours'=>$hours, 'checkin' =>$checkin);
